...
const form = useRef();
  ...
  const sendEmail = (data) => {
    ...
    emailjs.sendForm('FabLab_service', 'Fablab_Fsb', form.current, 'JhHD_fnBE7sejB7Zm')
      .then((result) => {
      ...
      <div className="container">
          ...
          <div className="col-lg-6">
            <div className="row">
              <div className="col-lg-12">
                <h2 className="m-b-10 font-bold text-xl" style={{color:"#EF5B0C"}}>{t("contact_title")}</h2>

                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3791.7464535536847!2d9.878731869749958!3d37.266874448408515!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12e31fcabaf83cd1%3A0x2e1cd92f29a2fa27!2sFacult%C3%A9%20des%20Sciences%20de%20Bizerte!5e1!3m2!1sfr!2stn!4v1676902109441!5m2!1sfr!2stn" width="600" height="450" style={{border:"0", marginTop:"2px", borderRadius:"20px"}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            ...
            <form ref={form} onSubmit={handleSubmit(sendEmail)} >
              <div className="row ">
                <div className="form-group col-md-6">
                  <label htmlFor="name" style={{color:"rgb(0, 132, 255)",fontSize:"18px"}}>{t("company_name")}</label>
                  <input
                    type="text"
                    name="CompanyName"
        ...
        storedTheme === "dark"
          ...
          : { color: "red",marginTop:"-20px",fontWeight:"600"  }
                ...
                <div className="form-group col-md-6">
                  <label htmlFor="email" style={{color:"rgb(0, 132, 255)",fontSize:"18px"}}>{t("email")}</label>
                  <input
                    type="email"
                    name="Email"
        ...
        storedTheme === "dark"
          ...
          : { color: "red",marginTop:"-20px",fontWeight:"600"  }
              ...
              <div className="form-group mt-n4">
                <label htmlFor="message" style={{color:"rgb(0, 132, 255)",fontSize:"18px"}}>{t('subject_label')}</label>
                <input
                  type="text"
                  name="Subject"
                  className="form-control required email"
        ...
        storedTheme === "dark"
          ...
          : { color: "red",marginTop:"-20px",fontWeight:"600"  }
              ...
              <div className="form-group mt-n4">
                <label htmlFor="message" style={{color:"rgb(0, 132, 255)",fontSize:"18px"}}>{t('phone_label')}</label>
                <input
                  type="text"
                  name="PhoneNumber"
                  className="form-control required email"
        ...
        storedTheme === "dark"
          ...
          : { color: "red",marginTop:"-20px",fontWeight:"600"  }
              ...
              <div className="form-group mt-n4">
                <label htmlFor="message" style={{color:"rgb(0, 132, 255)",fontSize:"18px"}}>{t("message")}</label>
                <textarea
                  type="text"
                  name="Message"
                  rows="8"
