...
const calculatePrice = () => {
  ...
  const startTime = document.getElementById('id_time1').value;
  const endTime = document.getElementById('id_time2').value;

  let pricePerHour = 0;

  if (material === "3D Printer") {
    if (type === "Etudiant externe") {
      pricePerHour = 6;
  ...
  } else if (material === "Vinyl cutting machine") {
    if (type === "Etudiant externe") {
      pricePerHour = 15;
    } else if (type === "Startup") {
      pricePerHour = 30;
  ...
  const start = new Date(`2023-06-01 ${startTime}`);
  const end = new Date(`2023-06-01 ${endTime}`);
  ...
  const handleReservationRequest = () => {
    ...
    const prix = document.getElementById('id_prix').value;
    ...
    axios.post('/api/reservations', reservation)
      .then(response => {
        ...
        document.getElementById('id_prix').value = '';
      ...
      <div className="panel panel-primary dialog-panel">
        ...
        <div className="panel-body">
          <form className="form-horizontal" role="form">
            ...
            <div className="form-group">
              <label className="control-label col-md-2 col-md-offset-2" htmlFor="id_type">Type</label>
              <div className="col-md-2">
                <select className="form-control" id="id_type">
                  <option>Etudiant externe</option>
...
{selectedDate && (
  <div>
    ...
    <div className="form-group">
        ...
        >
          ...
          {endTimes.map((time, index) => (
            ...
            <div className="form-group">
              ...
              <div className="col-md-2">
                <button className="btn-lg btn-warning" type="button" onClick={calculatePrice}>
                See price
                </button>
              </div>
      ...
      <p id="id_prix" style={{ marginTop: '20px', color: 'white',background:"#4A1231",textAlign:"center",padding:"20px",borderRadius:"20px" }}>
        Price: {price} TND
      </p>
