...
function Offers() {
  ...
  <div className="plan featured">
    <header>
      <h4 className="plan-title">Etudiant externe </h4>
      
    </header>
    <ul className="plan-features ">
    <h3 className="" style={{margin:"50px 50px 5px 50px"}}></h3>
      <li>
        <i className="ion-checkmark"> </i>  3D printer : 
        <span className="plan-price"> 6 TND</span>
        <span className="plan-type">/Hour </span>
    
      </li>

  
      <li>
        <i className="ion-checkmark"> </i>   Découpe laser :
        <span className="plan-price"> 15 TND</span>
        <span className="plan-type">/Hour</span>
    
      </li>

        <li>
        <i className="ion-checkmark"> </i>   Abonnement :
        <span className="plan-price"> 20 TND</span>
        <span className="plan-type">/Month</span>
    
      </li>
      <li>
        <i className="ion-checkmark"> </i>   Abonnement :
        <span className="plan-price"> 150 TND</span>
      ...
      <header>
      <h4 className="plan-title">Startup </h4>
    ...
    <li>
        <i className="ion-checkmark"> </i>  3D printer : 
        <span className="plan-price">10 TND</span>
        <span className="plan-type">/Hour </span>
      ...
      <li>
        <i className="ion-checkmark"> </i>   Découpe laser :
        <span className="plan-price"> 30 TND</span>
        <span className="plan-type">/Hour</span>
      ...
      <li>
        <i className="ion-checkmark"> </i>   Abonnement :
        <span className="plan-price"> 60 TND</span>
        <span className="plan-type">/Month</span>
    
      </li>
      <li>
        <i className="ion-checkmark"> </i>   Abonnement :
        <span className="plan-price"> 600 TND</span>
        <span className="plan-type">/Year</span>
...
{/* other plan */}
  ...
  <div className="plan">
    <header>
      <h4 className="plan-title">Entreprise</h4>
    ...
    <li>
      ...
      <li>
        <i className="ion-checkmark"> </i>   Découpe laser :
        <span className="plan-price"> 40 TND</span>
        <span className="plan-type">/Hour</span>
      ...
      <li>
        <i className="ion-checkmark"> </i>   Abonnement :
        <span className="plan-price"> 1500 TND</span>
        <span className="plan-type">/Year</span>
      ...
      <header>
      <h4 className="plan-title">Prototypage de circuits électroniques imprimés </h4>
      
    </header>
      
    <h3 className="" style={{margin:"50px 50px 5px 50px"}}> </h3>
    <li>
        <i className="ion-checkmark"> </i>  Conception PCB : 
        <span className="plan-price"> 1000 TND</span>
        
    
      </li>
      <li>
        <i className="ion-checkmark"> </i>  Gravure
...
<div className="plan featured">
    <header>
      <h4 className="plan-title">Formations et ateliers </h4>
    ...
    <h3 className="" style={{margin:"50px 50px 5px 50px"}}> </h3>
    <li>
        <i className="ion-checkmark"> </i>  Les tarifs des formations et des ateliers peuvent varier en fonction de la durée, de la spécialisation et du niveau de compétence requis. Vous pouvez envisager des tarifs allant de 300 DT à 2000 DT par session de formation ou atelier
    ...
    <div className="plan-select">
      <a href="/workshops">Select Plan</a>
    </div>
  </div>
  ...
  <div className="plan ">
    <header>
      <h4 className="plan-title">Other</h4>
      
    </header>
    <h3 className="" style={{margin:"50px 50px 5px 50px"}}> </h3>
    <ul className="plan-features">
      <li>
        <i className="ion-checkmark"> </i>Vente de matériaux et de consommables
      </li>
      <li>
        <i className="ion-checkmark"> </i>Partenariats et collaborations
      </li>
      <li>
        <i className="ion-checkmark"> </i>Événements communautaires
      </li>
      <li>
        <i className="ion-checkmark"> </i>Location d'espace de travail supplémentaire 
      </li>
      <li>
        <i className="ion-checkmark"> </i>Vente de produits fabriqués 
      </li>
      <li>
        <i className="ion-checkmark"> </i>Service de conseil 
      </li>
    </ul>
    <div className="plan-select">
